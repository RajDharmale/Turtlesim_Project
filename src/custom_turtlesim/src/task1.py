...
#         pid_linear = PIDController(kp=0.07, ki=0, kd=0.41)
#         pid_angular = PIDController(kp=0.1, ki=0, kd=0.21)

#         while self.euclidean_distance(goal_pose) >= distance_tolerance:
#             error_distance = self.euclidean_distance(goal_pose)
#             error_angle = self.steering_angle(goal_pose) - self.pose.theta

#             linear_speed = pid_linear.calculate(error_distance)
#             angular_speed = pid_angular.calculate(error_angle)
